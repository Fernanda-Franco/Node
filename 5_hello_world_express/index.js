...
// Exercício I: Crie uma rota que receba um parâmetro
// query `nome` e retorne uma mensagem de boas-vindas
// personalizada. Se `nome` não for fornecido, exiba uma
// mensagem de erro.
...
// Exercício II: Crie uma rota que receba dois 
//parâmetros query, `num1` e `num2`. Retorne como 
//resposta a soma dos números (se os dois numeros 
//não forem fornecidos mostrar uma mensagem de erro).
...
// Exercício III: Crie uma rota que receba um parâmetro
// query, `lang` e exiba uma mensagem de boas vindas no 
//idioma (português ou inglês). Caso a linguagem não seja
// fornecida ou suportada exiba uma mensagem de erro.
...
app.get("/usuarios/email/:email", (req, res) => {
  const { email } = req.params; //parametro de rotas
...
// Exercício II: Crie uma rota "/usuarios/novo", 
//e por meio dos parâmetros de consulta colete 
//nome e email para inserir no array de usuários.
